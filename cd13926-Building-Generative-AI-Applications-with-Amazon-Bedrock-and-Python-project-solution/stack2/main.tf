...
module "bedrock_kb" {
  ...
  aurora_arn        = "arn:aws:rds:us-west-2:184946923202:cluster:my-aurora-serverless"
  aurora_db_name    = "myapp"
  aurora_endpoint   = "my-aurora-serverless.cluster-c130adefrkyp.us-west-2.rds.amazonaws.com"
  ...
  aurora_secret_arn = "arn:aws:secretsmanager:us-west-2:184946923202:secret:my-aurora-serverless-m5nrLz"
  s3_bucket_arn = "arn:aws:s3:::bedrock-kb-184946923202"
}